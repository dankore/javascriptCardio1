...
//     const ageInventors = inventors.reduce((total, inventor) => {
//         return total + (inventor.passed - inventor.year);
//     }, 0)
//     console.table(ageInventors);
...
//     //answers
      ...
      btn.addEventListener("click", function onclick(event) {
         answer.innerHTML = "const bornIn1500s = inventors.filter((inventor) => inventor.year >= 1500 && inventor.year < 1600)";
      })
